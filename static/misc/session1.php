...
$_SESSION['greeting'] = "Hello Student, this is a cookie session stored";
...
<h1>This is the "session1.php" page.</h1>
...
<div margin="15px">
    <br><a href="/misc/session2.php" class="btn-hero w-button">Go to session 2 page</a><a href="/" target="_blank" class="btn-hero btn-hero2 hvr-bounce-to-right w-button w--current">Contact Us</a>
</div>
<div margin="15px">
